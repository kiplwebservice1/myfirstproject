...
module.exports = {
  ...
  update_session: function(currentUser, User, ObjectId, req, callback) {

    User.findById(new ObjectId(currentUser), function(err, user) {
  ...
  is_email_exists: function(User, email, recordId, callback) {
